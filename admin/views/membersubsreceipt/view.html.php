 ...
 * @since  0.0.1
 */
class MembersViewMemberSubsReceipt extends JViewLegacy
{
	/**
	...
	protected function addToolBar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MEMBERS_MEMBER_SUBS_RECEIPT'));
		//JToolBarHelper::custom('emailmember','','','Email',false);
